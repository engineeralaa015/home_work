...
//Prove encapsulation: include a commented line temp._celsius = 999; showing direct access is not allowed.
...
void main() {
  ...
  // 1. Setting a valid value
  temp.celsius = 25;
  print('Celsius: ${temp.celsius}');
  print('Fahrenheit: ${temp.fahrenheit}');

  // 2. Trying to set an invalid value
  temp.celsius = 150; // Should print 'Invalid temperature'

  // Prove encapsulation (this line will cause an error if uncommented)
  // temp._celsius = 999; // ❌ Error: '_celsius' can't be accessed outside the class
}
